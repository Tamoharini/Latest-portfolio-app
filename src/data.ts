...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      { name: "Node.js", level: 75, info: "Server-side runtimes and package scripts (Learning)" },
      { name: "Express.js", level: 75, info: "Building simple backend routes and middle-tier proxies" },
      { name: "MySQL", level: 85, info: "3NF normalisation, databases, stored procedures, joins" },
      { name: "MongoDB", level: 80, info: "BSON data structuring, collections modeling, MERN pipeline" }
    ]
  },
  {
...
export const CERTIFICATIONS = [
  ...
  "Built and deployed 14+ web development projects across HTML, CSS, JavaScript, React.js, MongoDB, and SQL."
];
